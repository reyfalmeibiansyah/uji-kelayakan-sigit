...
@section('content')
    ...
    <div class="container" style="margin-left: 12rem">
        ...
        <div class="d-flex">
            <h6 style="margin-right: 0.4rem;"><a class="nav-link text-secondary" href="{{ route('dashboard')}}">Home /</a></h6>
    ...
    <body>
        <div id="back-wrap">
            <a href="{{ route('letter.letters.data') }}" class="btn-back">Kembali</a>
            <a href="{{ route('letter.letters.download-pdf', $letter['id']) }}" class="btn-print"><i class="bi bi-download"></i></a>
        </div>
        <div id="letter">
            <div id="top">
                <div class="header">
